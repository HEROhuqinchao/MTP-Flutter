...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<SessionListItemEntity> sessions,  int selectedSessionIndex,  ActiveSessionEntity? currentSession,  bool isLoading,  bool isGenerating,  String? errorMessage,  String searchQuery)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.sessions,_that.selectedSessionIndex,_that.currentSession,_that.isLoading,_that.isGenerating,_that.errorMessage,_that.searchQuery);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<SessionListItemEntity> sessions,  int selectedSessionIndex,  ActiveSessionEntity? currentSession,  bool isLoading,  bool isGenerating,  String? errorMessage,  String searchQuery)  $default,) {final _that = this;
switch (_that) {
case _ChatState():
return $default(_that.sessions,_that.selectedSessionIndex,_that.currentSession,_that.isLoading,_that.isGenerating,_that.errorMessage,_that.searchQuery);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<SessionListItemEntity> sessions,  int selectedSessionIndex,  ActiveSessionEntity? currentSession,  bool isLoading,  bool isGenerating,  String? errorMessage,  String searchQuery)?  $default,) {final _that = this;
switch (_that) {
case _ChatState() when $default != null:
return $default(_that.sessions,_that.selectedSessionIndex,_that.currentSession,_that.isLoading,_that.isGenerating,_that.errorMessage,_that.searchQuery);case _:
  return null;
