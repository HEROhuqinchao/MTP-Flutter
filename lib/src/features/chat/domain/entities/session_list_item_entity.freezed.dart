...
/// Adds pattern-matching-related methods to [SessionListItemEntity].
extension SessionListItemEntityPatterns on SessionListItemEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SessionListItemEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SessionListItemEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SessionListItemEntity value)  $default,){
final _that = this;
switch (_that) {
case _SessionListItemEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SessionListItemEntity value)?  $default,){
final _that = this;
switch (_that) {
case _SessionListItemEntity() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  int type,  DateTime createdAt,  bool isPinned,  String? avatar,  int unreadCount,  DateTime? lastMessageAt,  String lastMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SessionListItemEntity() when $default != null:
return $default(_that.id,_that.title,_that.type,_that.createdAt,_that.isPinned,_that.avatar,_that.unreadCount,_that.lastMessageAt,_that.lastMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  int type,  DateTime createdAt,  bool isPinned,  String? avatar,  int unreadCount,  DateTime? lastMessageAt,  String lastMessage)  $default,) {final _that = this;
switch (_that) {
case _SessionListItemEntity():
return $default(_that.id,_that.title,_that.type,_that.createdAt,_that.isPinned,_that.avatar,_that.unreadCount,_that.lastMessageAt,_that.lastMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  int type,  DateTime createdAt,  bool isPinned,  String? avatar,  int unreadCount,  DateTime? lastMessageAt,  String lastMessage)?  $default,) {final _that = this;
switch (_that) {
case _SessionListItemEntity() when $default != null:
return $default(_that.id,_that.title,_that.type,_that.createdAt,_that.isPinned,_that.avatar,_that.unreadCount,_that.lastMessageAt,_that.lastMessage);case _:
  return null;
